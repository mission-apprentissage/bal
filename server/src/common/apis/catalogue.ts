...
export async function fetchCatalogueData(): Promise<object[]> {
  ...
  console.info(`${countResponse.data} formation(s) à importer du catalogue`);
...
export const ZCatalogueData = zFormationCatalogue.pick({
  email: true,
