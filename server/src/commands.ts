...
program.command("deca:hydrate").description("Remplissage des contrats Deca").option("-q, --queued", "Run job asynchronously", false).action(createJobAction("deca:hydrate"))
...
program.command("deca:s3:upload").description("DECA to ovh S3").option("-q, --queued", "Run job asynchronously", false).action(createJobAction("deca:s3:upload"))
