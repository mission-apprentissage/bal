...
Le cadre des dérogations pour un apprenti en contrat à durée limitée est précisé aux [articles D. 4154-2 à D. 4154-6 du code du travail](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000037001003/2021-06-14).`,
  ...
  "contrat.caisseRetraiteSupplementaire": {
    ...
    options: [
      { label: "AG2R Agirc-Arrco", value: "AG2R Agirc-Arrco" },
      {
        label: "Agrica (Alliance professionnelle) Agirc-Arrco",
        value: "Agrica (Alliance professionnelle) Agirc-Arrco",
      },
      { label: "Apicil Agirc-Arrco", value: "Apicil Agirc-Arrco" },
      {
        label: "Audiens (Alliance professionnelle)  Agirc-Arrco",
        value: "Audiens (Alliance professionnelle)  Agirc-Arrco",
      },
      { label: "B2V (Alliance professionnelle) Agirc-Arrco", value: "B2V (Alliance professionnelle) Agirc-Arrco" },
      { label: "Banque de France", value: "Banque de France" },
      { label: "BTPR Agirc-Arrco", value: "BTPR Agirc-Arrco" },
      ...
      { label: "CGRR Agirc-Arrco", value: "CGRR Agirc-Arrco" },
      { label: "CIPAV", value: "CIPAV" },
      { label: "CNAV", value: "CNAV" },
      { label: "CNAVPL", value: "CNAVPL" },
      { label: "CNBF", value: "CNBF" },
      { label: "CNIEG", value: "CNIEG" },
      { label: "CNRACL", value: "CNRACL" },
      { label: "CPRN", value: "CPRN" },
      { label: "CPRP SNCF", value: "CPRP SNCF" },
      { label: "Cropera", value: "Cropera" },
      { label: "CRP RATP", value: "CRP RATP" },
      { label: "CRPCEN", value: "CRPCEN" },
      { label: "CRPCF", value: "CRPCF" },
      { label: "CRPN", value: "CRPN" },
      { label: "CRR Agirc-Arrco", value: "CRR Agirc-Arrco" },
      { label: "ENIM", value: "ENIM" },
      { label: "FSPOEIE", value: "FSPOEIE" },
      { label: "IRCANTEC", value: "IRCANTEC" },
      { label: "IRCEC", value: "IRCEC" },
      { label: "Ircem Agirc-Arrco", value: "Ircem Agirc-Arrco" },
      { label: "Ircom Agirc-Arrco", value: "Ircom Agirc-Arrco" },
      {
        label: "IRP Auto (Alliance professionnelle) Agirc-Arrco",
        value: "IRP Auto (Alliance professionnelle) Agirc-Arrco",
      },
      { label: "Klesia Carcept Agirc-Arrco", value: "Klesia Carcept Agirc-Arrco" },
      {
        label: "Lourmel (Alliance professionnelle) Agirc-Arrco",
        value: "Lourmel (Alliance professionnelle) Agirc-Arrco",
      },
      { label: "Malakoff Humanis Agric-Arrco", value: "Malakoff Humanis Agric-Arrco" },
      ...
      {
        label: "PRO BTP (Alliance professionnelle) Agirc-Arrco",
        value: "PRO BTP (Alliance professionnelle) Agirc-Arrco",
      },
