...
export const ZMailingList = z
  .object({
    ...
    status: z
      .enum([
        MAILING_LIST_STATUS.PROCESSING,
        MAILING_LIST_STATUS.DONE,
        MAILING_LIST_STATUS.ERROR,
      ])
      .optional(),
    ...
    secondary_email: z
      .string()
      .optional()
      .describe("Nom de la colonne email secondaire"),
    identifier_columns: z
      .array(z.string())
      .describe("Liste des colonnes d'identifiants"),
    output_columns: z
      .array(
        z.object({
          column: z.string(),
    ...
    document_id: z
      .string()
      .optional()
      .describe("Identifiant du document généré"),
...
export type MailingListWithDocumentJson = Jsonify<
  z.input<typeof ZMailingListWithDocument>
>;
