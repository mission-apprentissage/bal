...
const Accessibilite = () => {
  ...
  return (
    <>
      ...
      <Section>
        <Typography>
          L&apos;initiative internationale pour l&apos;accessibilité du Web (Web Accessiblility Initiative) définit l&apos;accessibilité du Web comme suit :<br />
          <br />
          ...
          <br />
          <br />
          Le site Catalogue de l&apos;offre de formation en apprentissage est en cours d&apos;optimisation afin de le rendre conforme au{" "}
