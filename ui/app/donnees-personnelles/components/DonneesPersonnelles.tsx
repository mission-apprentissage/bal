    ...
    <Grid container spacing={2}>
      ...
      <Grid item xs={12} lg={9}>
        ...
        <Typography>
          Le BAL est{" "}
          <strong>
            construit dans le respect de la vie privée des personnes et applique
            les standards de sécurité de l&apos;État.
          </strong>
        </Typography>
        ...
        <Section>
          ...
          <Typography gutterBottom>
            C’est sur cette dernière base légale que se fonde notre traitement.
            En effet, la Mission a accès à certaines données à caractère
            personnel (état civil, coordonnées, code formation, statut inscrit,
            apprenti, ou abandon) enregistrées dans les systèmes de gestion des
            CFA pour les années n et n-1, afin de proposer des nouveaux
            services, de réaliser des études de cohorte et des analyses de
            données pour améliorer la qualité du service public rendu.
          </Typography>
          <Typography>
            ...
            mission Houzel fait l’objet de deux lettres en date du 10 septembre
            2019 puis du 25 février 2020, mais aussi de deux décisions du
            gouvernement en date du 26 novembre 2019 et du 15 octobre 2020.
          </Typography>
        </Section>
        ...
        <Section>
          ...
          <ul>
            ...
            <li>
              <strong>De dénombrer et identifier les CFAs</strong> dans lesquels
              des jeunes sont en recherche de contrat ou en risque de décrochage
              ;
            </li>
            <li>
        ...
        <Section>
          ...
          <Typography>
            Dans le respect du RGPD, seules les données utiles à la construction
            du {productName} sont collectées.
          </Typography>
          <Typography>Données concernant l’apprenant :</Typography>
          <ul>
            <li>
              <strong>Identification</strong> : nom, prénom, date de naissance,
              tel, e-mail, Code Insee résidence, INE ;
            </li>
            <li>
              <strong>Formation suivie</strong> : Code Formation Diplôme, RNCP,
              libellé, période de la formation, année dans la formation, année
              scolaire, date début de formation ;
            </li>
            <li>
              <strong>Le statut de l’apprenant</strong> : apprenti, inscrit sans
              contrat, rupturant, abandon
            </li>
          </ul>
          <Typography>Données concernant l’organisme :</Typography>
          <ul>
            <li>
              <strong>Identification</strong> : UAI, SIRET, Nom, Code Insee CFA
              Formateur
            </li>
          </ul>
          <Typography>
