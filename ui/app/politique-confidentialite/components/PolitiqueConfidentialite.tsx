    ...
    <Grid container spacing={2}>
      ...
      <Grid size={{ xs: 12, lg: 9 }}>
        ...
        <Section>
          ...
          <Typography>Le tableau de bord de l’apprentissage est développé par la Mission nationale pour l’apprentissage, mandatée par le ministère du Travail.</Typography>
        </Section>
        ...
        <Section mt={4} id={anchors.Finalite}>
          ...
          <Typography>
            Nous manipulons des données à caractère personnel pour améliorer la qualité du suivi et du pilotage de l’apprentissage par les différents acteurs. Plus précisément,
            elles visent à :
          </Typography>
          <ul>
            <li>
              Produire sous la forme d’un tableau de bord les données synthétiques des effectifs de l&apos;apprentissage afin de contribuer au pilotage de l’apprentissage au niveau
              national et territorial par les acteurs publics ou avec délégation de service public ;
            </li>
            <li>Identifier les jeunes en recherche de contrat ou en situation de décrochage pour améliorer leur accompagnement ;</li>
            <li>Produire les données nécessaires aux organismes de formation pour répondre aux enquêtes (notamment SIFA) ;</li>
        ...
        <Section mt={4} id={anchors.DonneesACaracterePersonelTraitees}>
          ...
          <Typography>Nous traitons les données à caractère personnel et catégories de données à caractère personnel suivantes :</Typography>
          <ul>
            <li>Données relatives à l’identification du candidat ou jeune (nom, prénom, date de naissance, INE, adresse e-mail) ;</li>
        ...
        <Section id={anchors.BaseJuridiqueDuTraitementDeDonnees}>
          ...
          <Typography>
            Nous sommes autorisés à traiter vos données dans le cadre d’une mission d’intérêt public ou relevant de l’exercice de l’autorité publique dont est investi le
            responsable de traitement au sens de l’article 6-e du RPGD. Cette mission est notamment précisée dans la lettre de Mission de la Mission nationale pour l’apprentissage
            du 10 septembre 2019 et décision gouvernementale du 26 novembre 2019.
          </Typography>
        </Section>
        <Section mt={4} id={anchors.DureeDeConservation}>
          ...
          <Typography>Nous conservons vos données pour une durée de 2 ans à compter de la dernière modification liée aux informations sur un candidat.</Typography>
        </Section>
        <Section mt={4} id={anchors.DroitDesPersonnesConcernees}>
          ...
          <Typography>
            <br />
            Pour les exercer, faites-nous parvenir une demande en précisant la date et l’heure précise de la requête – ces éléments sont indispensables pour nous permettre de
            retrouver votre recherche – par voie électronique à l’adresse suivante : <Link href={`mailto:${CONTACT_ADDRESS}`}>{CONTACT_ADDRESS}</Link>
            <br />
            <br />
            Par voie postale :
            <br />
            ...
            <br />
            <br />
            En raison de l’obligation de sécurité et de confidentialité dans le traitement des données à caractère personnel qui incombe au responsable de traitement, votre demande
            ne sera traitée que si vous apportez la preuve de votre identité. <br />
            Pour vous aider dans votre démarche, vous trouverez ici
            <br />
            <Link href="https://www.cnil.fr/fr/modele/courrier/exercer-son-droit-dacces">https://www.cnil.fr/fr/modele/courrier/exercer-son-droit-dacces</Link>, un modèle de
        ...
        <Section mt={4} id={anchors.DestinatairesDesDonnees}>
          ...
          <Typography>Nous nous engageons à ce que les données à caractères personnels soient traitées par les seules personnes autorisées.</Typography>
          <br />
          ...
          <ul>
            ...
            <li>
              Les personnes travaillant pour le compte de la mission interministérielle pour l’apprentissage dans le cadre de propositions ciblées d&apos;offres d’emploi ou
              d’alternance ;
            </li>
          </ul>
        </Section>
        <Section mt={4} id={anchors.SecuriteEtConfidentialiteDesDonnees}>
          ...
          <Typography>
            Un cookie est un fichier déposé sur votre terminal lors de la visite d’un site. Il a pour but de collecter des informations relatives à votre navigation et de vous
            adresser des services adaptés à votre terminal (ordinateur, mobile ou tablette).
            <br />
            <br />
            Le site ne dépose pas de cookies de mesure d’audience (nombre de visites, pages consultées). Néanmoins, nous utilisons Plausible qui permet de suivre les tendances
            d’utilisation de notre site. L’outil ne permet pas d’identifier les personnes, ni de tracer votre usage d’internet, dans ou en dehors du site.
            <br />
            <br />
