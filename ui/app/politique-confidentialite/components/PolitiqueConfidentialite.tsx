...
const anchors = {
  ...
  SecuriteEtConfidentialiteDesDonnees:
    ...
    >
      ...
      <Box>
        <Section pt="0">
          ...
          <Text>
            Le tableau de bord de l’apprentissage est développé par la Mission
            nationale pour l’apprentissage, mandatée par le ministère du
            Travail.
          </Text>
        </Section>
        <Section mt={4} id={anchors.Finalite}>
          ...
          <Text>
            Nous manipulons des données à caractère personnel pour améliorer la
            qualité du suivi et du pilotage de l’apprentissage par les
            différents acteurs. Plus précisément, elles visent à :
          </Text>
          <UnorderedList ml="30px !important" mt="1w">
            <ListItem>
              Produire sous la forme d’un tableau de bord les données
              synthétiques des effectifs de l&apos;apprentissage afin de
              contribuer au pilotage de l’apprentissage au niveau national et
              territorial par les acteurs publics ou avec délégation de service
              public ;
            </ListItem>
            <ListItem>
              Identifier les jeunes en recherche de contrat ou en situation de
              décrochage pour améliorer leur accompagnement ;
            </ListItem>
            <ListItem>
              Produire les données nécessaires aux organismes de formation pour
              répondre aux enquêtes (notamment SIFA) ;
            </ListItem>
            <ListItem>
              Créer un compte pour accéder ou fournir des données;
            </ListItem>
            <ListItem>
              Suivre et piloter l&apos;usage du tableau de bord par
              l&apos;équipe Mission apprentissage ;
            </ListItem>
            <ListItem>
              Identifier les organismes de formation et leurs réseaux
              (référentiel).
            </ListItem>
          </UnorderedList>
        </Section>
        <Section mt={4} id={anchors.DonneesACaracterePersonelTraitees}>
          ...
          <Text>
            Nous traitons les données à caractère personnel et catégories de
            données à caractère personnel suivantes :
          </Text>
          <UnorderedList ml="30px !important" mt="1w">
            <ListItem>
              Données relatives à l’identification du candidat ou jeune (nom,
              prénom, date de naissance, INE, adresse e-mail) ;
            </ListItem>
            <ListItem>
              Données relatives au représentant légal du jeune (nom, numéro de
              téléphone) ;
            </ListItem>
            <ListItem>
              Données relatives aux évènements du parcours des apprenants (date
              de début et de fin, date de début fin de contrat, et rupture,
              organisme de formation et département) ;
            </ListItem>
            <ListItem>
        ...
        <Section mt={4} id={anchors.BaseJuridiqueDuTraitementDeDonnees}>
          ...
          <Text>
            Nous sommes autorisés à traiter vos données dans le cadre d’une
            ...
            l’article 6-e du RPGD. Cette mission est notamment précisée dans la
            lettre de Mission de la Mission nationale pour l’apprentissage du 10
            septembre 2019 et décision gouvernementale du 26 novembre 2019.
          </Text>
        </Section>
        <Section mt={4} id={anchors.DureeDeConservation}>
          ...
          <Text>
            Nous conservons vos données pour une durée de 2 ans à compter de la
            dernière modification liée aux informations sur un candidat.
          </Text>
        </Section>
        <Section mt={4} id={anchors.DroitDesPersonnesConcernees}>
          ...
          <Text>
            ...
            apportez la preuve de votre identité. <br />
        ...
        <Section mt={4} id={anchors.DestinatairesDesDonnees}>
          ...
          <Text>
            Nous nous engageons à ce que les données à caractères personnels
          ...
          <UnorderedList ml="30px !important" mt="1w">
            <ListItem>
              Les agents autorisés des DREETS, dans le cadre de leurs missions
              de service public ;
            </ListItem>
            ...
            <ListItem>
              Les personnes autorisées au sein des Rectorats, dans le cadre de
              leurs missions de service public ;
            </ListItem>
            <ListItem>
              Les personnes autorisées au sein des Académies, dans le cadre de
              leurs missions de service public ;
            </ListItem>
            <ListItem>
              Les personnes autorisées travaillant pour le compte de la mission
              interministérielle pour l’apprentissage dans le cadre de la
              conception des services numériques ;
            </ListItem>
            <ListItem>
              Les personnes travaillant pour le compte de la mission
              interministérielle pour l’apprentissage dans le cadre de
              propositions ciblées d&apos;offres d’emploi ou d’alternance ;
            </ListItem>
          </UnorderedList>
        </Section>
        <Section mt={4} id={anchors.SecuriteEtConfidentialiteDesDonnees}>
          ...
          <Text>
            ...
            <br />
            <br />
            Le site ne dépose pas de cookies de mesure d’audience (nombre de
            visites, pages consultées). Néanmoins, nous utilisons Plausible qui
            permet de suivre les tendances d’utilisation de notre site. L’outil
            ne permet pas d’identifier les personnes, ni de tracer votre usage
            d’internet, dans ou en dehors du site.
            <br />
            <br />
