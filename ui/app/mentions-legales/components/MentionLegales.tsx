    ...
    <Grid container spacing={2}>
      ...
      <Grid size={{ xs: 12, lg: 9 }}>
        ...
        <Section id={anchors.EditeurDuSite}>
          ...
          <Typography>
            Ce site est édité par la Délégation Générale à l’Emploi et à la Formation Professionnelle (DGEFP) et la Mission interministérielle de l’apprentissage.
            <br />
            <br />
        ...
        <Section id={anchors.DirecteurDeLaPublication}>
          ...
          <Typography gutterBottom>Le Directeur de la publication est Monsieur Bruno Lucas, Délégué général à l’Emploi et à la Formation Professionnelle.</Typography>
        </Section>
        ...
        <Section id={anchors.Accessibilite}>
          ...
          <Typography>La conformité aux normes d’accessibilité numérique est un objectif ultérieur mais nous tâchons de rendre ce site accessible à toutes et à tous.</Typography>
        </Section>
