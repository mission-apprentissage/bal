...
--data-raw "{
    \"token\": \"$TOKEN\",
    \"user\": {
        \"password_confirm\": \"{{ MNA_BAL_METABASE_ADMIN_PASS }}\",
        \"password\": \"{{ MNA_BAL_METABASE_ADMIN_PASS }}\",
        \"site_name\": \"boite aux lettres\",
        \"email\": \"{{ MNA_BAL_METABASE_ADMIN_EMAIL }}\",
        \"last_name\": null,
        \"first_name\": null
    },
    \"database\": {
        ...
        \"details\": {
            \"use-conn-uri\": true,
            \"conn-uri\": \"{{ MNA_BAL_MONGODB_METABASE_URI }}\",
