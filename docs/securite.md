...
Les secrets sont chiffré via GPG, et stockés dans des fichiers **SOPS**. Veuillez consulter la doc [Gestion des secrets](./infrastructure/manage.md#gestion-des-secrets)
